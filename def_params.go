...
// is the default set of parameters -- Base is always applied, and others can be optionally
...
var ParamSets = params.Sets{
	{Name: "Base", Desc: "these are the best params", Sheets: params.Sheets{
		"Network": &params.Sheet{
			...
			{Sel: "#PFCToECin", Desc: "PFC inhibition of overlapping pools",
				Params: params.Params{
					"Prjn.WtInit.Var":  "0",
					"Prjn.WtScale.Abs": "1",
					"Prjn.WtScale.Rel": "1",
				}},
			{Sel: "#PFCToCA1", Desc: "PFC inhibition of overlapping pools in CA1",
				Params: params.Params{
					"Prjn.WtInit.Var":  "0",
					"Prjn.WtScale.Abs": "1",
					"Prjn.WtScale.Rel": "1",
				}},
			{Sel: "#PFCToECout", Desc: "PFC inhibition of overlapping pools in ECout",
				Params: params.Params{
					"Prjn.WtInit.Var":  "0",
					"Prjn.WtScale.Abs": "1",
					"Prjn.WtScale.Rel": "1",
			...
			{Sel: ".PFC", Desc: "all PFC layers: only pools, no layer-level", //make this inhibition layer
				Params: params.Params{
					"Layer.Act.Gbar.L":        "0.1",
					"Layer.Inhib.ActAvg.Init": "0.2",
			...
			{Sel: "#DG", Desc: "very sparse = high inhibition",
				Params: params.Params{
					...
					"Layer.Inhib.Layer.Gi":    "3.3", // 3.8 > 3.6 > 4.0 (too far -- tanks)
				}},
			...
			{Sel: "#CA1", Desc: "CA1 only Pools",
				Params: params.Params{
					...
					"Layer.Inhib.ActAvg.UseFirst": "false", // first activity is too low, throws off scaling
					"Layer.Inhib.Layer.On":        "false",
					"Layer.Inhib.Pool.On":         "true",
